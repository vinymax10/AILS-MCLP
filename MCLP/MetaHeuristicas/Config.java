...
public class Config implements Cloneable
{
	...
	TipoAlgorithm tipoAlgorithm;
	
	public Config() 
	{
//		----------------------------Main----------------------------
		this.tipoAlgorithm=TipoAlgorithm.AILS;
...
//		this.etaMin=0.01;
		...
		this.tipoSubConj=TipoSubConj.SubConj20;
		...
		this.tipoConst=TipoConst.Const1;
	}
	...
	public TipoConst getTipoConst() {
		return tipoConst;
	}

	public void setTipoConst(TipoConst tipoConst) {
	...
	public TipoSubConj getTipoSubConj() {
		return tipoSubConj;
	}

	public void setTipoSubConj(TipoSubConj tipoSubConj) {
		this.tipoSubConj = tipoSubConj;
	}
	...
	public TipoAlgorithm getTipoAlgorithm() {
		return tipoAlgorithm;
	}

	public void setTipoAlgorithm(TipoAlgorithm tipoAlgorithm) {

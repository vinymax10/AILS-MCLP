...
//	}
	...
	public boolean verificarAdj()
	{
		...
		for(int i = 0; i < possoAtender.length - 1; i++)
		{
			...
			{
				System.out.println("possoAtender[i]: " + possoAtender[i] + " possoAtender[i+1]: " + possoAtender[i + 1]);
				return false;
			}
		}
...
//		System.out.println(Arrays.toString(possoAtenderR2));
	...
	{
		return "NoSol [facilidade=" + facilidade + ", demanda=" + demanda + ", beneficio=" + beneficio + " intersec=" + intersec + " esclusividade="
		+ esclusividade + ", variacao=" + variacao + ", nome=" + nome + ", numFacilidades=" + numFacilidades + "]";
	}

...
//BestImproviment.
public class PathReLinking5 extends PathReLinking
{
	int indexEntra=0, indexSai=0,bestIndexSai=0,bestIndexEntra=0,novoF,bestF;
	
	public PathReLinking5(Instancia instancia,MetaHeuristicas.Config config, Estatistica estatistica)
	{
		super(instancia, config, estatistica);
		this.tipoPathReLinking=TipoPathReLinking.PathReLinking5;
	}
	...
	public boolean pathReLinking(Solucao inicial, Solucao guia) 
	{
		...
		while(topNosSaem>0)
		{
			...
			solucao.addFacilidade(nosSaem[bestIndexSai].entra);

...
public class PathReLinking
{
	...
	public PathReLinking(Instance instancia, Config config)
	{
		...
		this.mTopNosSaem = new Media(config.getGamma());
	}
...
//			iterador++;
			...
			if((!achou && solucao.f > inicial.f && solucao.f > guia.f) || (achou && solucao.f > inicial.f && solucao.f > guia.f && solucao.f > melhorSolucao.f))
			{

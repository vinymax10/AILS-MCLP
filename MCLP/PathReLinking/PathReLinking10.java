...
//variacaoCrescente
public class PathReLinking10 extends PathReLinking
{
	...
	public PathReLinking10(Instancia instancia,MetaHeuristicas.Config config, Estatistica estatistica)
	{
		super(instancia, config, estatistica);
		this.tipoPathReLinking=TipoPathReLinking.PathReLinking10;
	}
...
//		{
//			System.out.println(nosSaem[i].variacao);
//		}

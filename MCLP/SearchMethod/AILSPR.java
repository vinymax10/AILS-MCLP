...
//		System.out.println("best: "+best);
		...
		try {
			...
			this.subConj=new SubConj(instancia,config,distEntreSolucoes,distElite);
			...
			for (int i = 0; i < perturbadores.length; i++) 
			{
				...
				getConstructor(Instancia.class,Config.class,AjusteOmega.class).
				newInstance(instancia,config,ajusteOmega);

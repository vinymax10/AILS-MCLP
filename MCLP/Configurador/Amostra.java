...
public class Amostra implements Runnable
{
	...
	public Amostra(Config config,DadosInstancia dadosInstancia, double limite,ResultMedio resultMedio,Experimento experimento) 
	{
	...
	public void run() 
	{
		...
		resultMedio.setResult(result);
		experimento.avisarTerminou();
	}

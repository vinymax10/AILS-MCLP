...
public class BuscaLocalFirst14 implements BuscaLocal
{
	...
	public BuscaLocalFirst14(Instancia instancia,Config config)
	{
	...
	public void buscaLocal(Solucao s)
	{
		...
		while(melhorou) 
		{
			...
			for (int i = 0; i < numFacilidades; i++)
			{
				...
				for (int t = 0; t < solucao[indexI].possoAtenderR2.length; t++) 
				{
					aux=solucaoFixa[solucao[indexI].possoAtenderR2[t]];
					aux.beneficioAnt=aux.beneficio;
				}
